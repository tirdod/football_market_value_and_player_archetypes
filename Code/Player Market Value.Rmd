...
y_train_90s <- as.numeric(unlist(read_csv("train_test_data/y_train_90s.csv", show_col_types = FALSE)[,-1]))

X_test_90s <- read_csv("train_test_data/X_test_90s.csv", show_col_types = FALSE)[,-1]
y_test_90s <- as.numeric(unlist(read_csv("train_test_data/y_test_90s.csv", show_col_types = FALSE)[,-1]))

# Load the prepared datasets - totals
X_train_totals <- read_csv("train_test_data/X_train_totals.csv", show_col_types = FALSE)[,-1]
y_train_totals <- as.numeric(unlist(read_csv("train_test_data/y_train_totals.csv", show_col_types = FALSE)[,-1]))

X_test_totals <- read_csv("train_test_data/X_test_totals.csv", show_col_types = FALSE)[,-1]
y_test_totals <- as.numeric(unlist(read_csv("train_test_data/y_test_totals.csv", show_col_types = FALSE)[,-1]))
